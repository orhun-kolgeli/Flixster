...
![Demo](https://github.com/orhun-kolgeli/Flixster/blob/master/FlixGIF.gif)

## Notes

It was challenging to keep track of all the classes and connect all the files in Android Studio.
